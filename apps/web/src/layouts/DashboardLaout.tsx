...
//       {/* Hero */}
//       <header className="border-b bg-linear-to-b from-primary/10 via-background to-background">
...
//             <h1 className="bg-linear-to-r from-primary to-brand bg-clip-text text-5xl font-black tracking-tight text-transparent md:text-7xl">
...
//                     className={cn("gap-2 cursor-pointer hover:bg-brand hover:text-white", isActive && "bg-brand dark:text-white")}
//                   >
...
//                 variant="outline"
//                 onClick={logout}
//                   className={cn("gap-2 cursor-pointer hover:bg-brand hover:text-white ")}
//               >
...
//         <Card className="ring-primary/5 bg-primary/5 p-8">
                ...
                {({ isActive }) => (
                  <Button
                    ...
                    className={cn(
                      ...
                      isActive && "border-brand/40 bg-brand text-white shadow-lg shadow-brand/20"
                    )}
                  >
                    <LayoutDashboard className="size-4" />
                    Dashboard
